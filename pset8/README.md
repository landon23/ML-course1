There are two problems in this problem set.  The first is to implement a K-means algorithm and train it on a subset of the MNIST database.  Its performance is investigated using the Rand index.
